...
{% tabs %}
{% tab title="Practice Problem 2.53" %}
...
{% tab title="Practice Problem 2.54" %}
...
{% tab title="Solution 2.54" %}
A. true

B. false        example: x=TMax

C. false        example: d=0.1
...
H. false        example: d=DMax, f=FMax, will overflow, (f+d)-f=+∞
{% endtab %}
{% endtabs %}
