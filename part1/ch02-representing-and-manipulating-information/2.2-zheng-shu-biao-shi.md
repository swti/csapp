...
![Figure 2.10
Typical ranges for C integral data types for 64-bit programs.](<../../.gitbook/assets/image (17) (1) (1) (1) (1).png>)
...
![Figure 2.12
Unsigned number examples for w = 4. When bit i in the binary representation has value 1, it contributes 2i to the value.](<../../.gitbook/assets/image (18) (1) (1) (1) (1) (1).png>)
...
![Figure 2.13
Two’s-complement number examples for w = 4. Bit 3 serves as a sign bit; when set to 1, it contributes − = −8 to the value. This weighting is shown as a leftwardpointing gray bar.](<../../.gitbook/assets/image (14) (1) (1).png>)
