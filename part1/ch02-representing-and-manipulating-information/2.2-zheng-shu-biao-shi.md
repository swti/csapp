...
![Figure 2.13 Two’s-complement number examples for w = 4. Bit 3 serves as a sign bit; when set to 1, it contributes − = −8 to the value. This weighting is shown as a leftwardpointing gray bar.](<../../.gitbook/assets/image (14) (1).png>)
...
![Figure 2.14 Important numbers. Both numeric values and hexadecimal representations are shown.](<../../.gitbook/assets/image (15) (1).png>)
