...
![Figure 2.21 Integer addition. With a 4-bit word size, the sum could require 5 bits](<../../.gitbook/assets/image (23).png>)
...
![Figure 2.22 Relation between integer addition and unsigned addition. When x + y is greater than 2w − 1, the sum overflows.](<../../.gitbook/assets/image (22).png>)
...
![Figure 2.23
Unsigned addition. With a 4-bit word size, addition is performed modulo 16.](<../../.gitbook/assets/image (21).png>)
