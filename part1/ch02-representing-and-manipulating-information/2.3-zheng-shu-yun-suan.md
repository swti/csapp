...
{% tab title="PP 2.37" %}
Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:Fill in the following table showing the results of multiplying different 3-bit numbers, in the style of Figure 2.27:
{% endtab %}
{% endtabs %}
