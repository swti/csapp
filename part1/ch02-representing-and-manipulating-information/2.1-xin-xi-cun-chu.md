...
![Figure 2.2 Hexadecimal notation. Each hex digit encodes one of 16 values.](<../../.gitbook/assets/image (1) (1) (1) (1) (1) (1) (1).png>)
...
![0x173A4C to binary](<../../.gitbook/assets/image (2) (1) (1) (1) (1).png>)
...
![1111001010110110110011 to hexadecimal](<../../.gitbook/assets/image (2) (1) (1) (1) (1) (1).png>)
...
![Figure 2.3 Typical sizes (in bytes) of basic C data types. The number of bytes allocated varies with how the program is compiled. This chart shows the values typical of 32-bit and 64-bit programs.](<../../.gitbook/assets/image (1) (1) (1) (1) (1).png>)
...
![Figure 2.6 Byte representations of different data values. Results for int and float are identical, except for byte ordering. Pointer values are machine dependent.](<../../.gitbook/assets/image (4) (1) (1) (1) (1).png>)
...
![Figure 2.7 Operations of Boolean algebra. Binary values 1 and 0 encode logic values true and false, while operations \~, &, |, and ^ encode logical operations not, and, or, and exclusive-or, respectively.](<../../.gitbook/assets/image (2) (1) (1) (1).png>)
