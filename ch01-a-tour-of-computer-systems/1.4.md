...
![Figure 1.5 Reading the hello command from the keyboard.](<../.gitbook/assets/image (9).png>)
...
![Figure 1.6 Loading the executable from disk into main memory](<../.gitbook/assets/image (16).png>)
...
![Figure 1.7 Writing the output string from memory to the display](<../.gitbook/assets/image (5).png>)
