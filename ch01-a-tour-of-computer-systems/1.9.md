...
![Figure 1.16 Categorizing different processor configurations. Multiprocessors are becoming prevalent with the advent of multicore processors and hyperthreading.](<../.gitbook/assets/image (8).png>)
...
![Figure 1.17 Multi-core processor organization. Four processor cores are integrated onto a single chip.](<../.gitbook/assets/image (2).png>)
...
![Figure 1.18 Some abstractions provided by a computer system. A major theme in computer systems is to provide abstract representations at different levels to hide the complexity of the actual implementations.](<../.gitbook/assets/image (10).png>)
